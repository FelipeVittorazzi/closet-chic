    ...
    <div class="card-body">
        <form method="POST" action="{{ route('cliente.form') }}" novalidate>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="cpf" name="cpf" type="text" class="form-control is-invalid" value="{{ old('cpf') }}" required autofocus>
                    @error('cpf')
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="phone" name="phone" type="tel" class="form-control is-invalid" required autofocus>
                    @error('phone')
                    <div class="error-message invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
